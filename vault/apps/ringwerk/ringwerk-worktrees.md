---
id: ringwerk-worktrees
type: guide
title: "Ringwerk — Git Worktrees – Bekannte Einschränkungen"
aliases: ["Git Worktrees – Bekannte Einschränkungen"]
keywords: [ringwerk, worktrees, bekannte, einschränkungen]
part_of: ["[[ringwerk]]"]
---

**TL;DR** Wenn ein Worktree unter `.claude/worktrees/<name>/` liegt, funktioniert der `/check`-Befehl (`docker compose -f docker-compose.dev.yml run --rm app ...`) **nicht korrekt** für den Worktree:
