---
id: ringwerk-architecture
type: guide
title: "Ringwerk — Architektur – Ringwerk"
aliases: ["Architektur – Ringwerk"]
keywords: [ringwerk, architektur, ringwerk]
part_of: ["[[ringwerk]]"]
---

**TL;DR** Verbindlich gleichrangig mit `docs/technical.md`. Neue Dateien immer gemäss dieser Struktur anlegen.
...
src/
  ...
  components/
    ui/
      ...
      rank-badge.tsx          ← gemeinsamer RankBadge (gold/silber/bronze/muted Pill, Props: rank, podium? — false = neutral für Zeilen ohne Ergebnis)
    app/
