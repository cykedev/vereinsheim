...
aliases: ["Monorepo-Migration — Plan"]
keywords: [monorepo-migration, plan]
part_of: ["[[overview]]"]
---

**TL;DR** Ringwerk und Treffsicher werden als `apps/*` in `vereinsheim` integriert, geteilter Code wandert
